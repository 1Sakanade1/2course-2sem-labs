...
insert into GROUPS   (FACULTY,  PROFESSION, YEAR_FIRST )   --TODO FIX BUG WITH COMPILE
...
insert into STUDENT (IDGROUP,NAME, BDAY)							
    values 
		   ...
		   (10, 'Силюк Валерия Ивановна',         '12.07.1994'),
           (10, 'Сергель Виолетта Николаевна',    '06.03.1994'),
           (10, 'Добродей Ольга Анатольевна',     '09.11.1994'),
           (11, 'Подоляк Мария Сергеевна',        '04.10.1994'),
...
-- TEACHER CREATION
 create table TEACHER                                                 --TODO FIX BUG
