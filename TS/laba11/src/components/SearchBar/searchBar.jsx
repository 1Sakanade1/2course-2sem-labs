        ...
        <div className="wrapperSearch">
            <div className="containerSearch">
                <div className="containerForCountry">
                    <img src={arrow} alt="не загрузилось" className="imageCountry"/>
                ...
                <div className="containerForCountry VisSchedule">
                    <img src={time} alt="не загрузилось" className="imageCountry"/>
                ...
                <img src={job} alt="не загрузилось" className="imageCountry"/>
                    <FormControl fullWidth>
                ...
                <img src={star} alt="не загрузилось" className="imageCountry"/>
                    <FormControl fullWidth>
                ...
                <div className="containerForCountry VisIncome">
                    <img src={cost} alt="не загрузилось" className="imageCountry"/>
